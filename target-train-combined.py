...
with open(f"dataset_splits{num_epochs}.json", "w") as f:
...
class MaliciousFlowerClient(fl.client.NumPyClient):
    def __init__(self, model, client_id, data_loader,num_epochs):
        ...
        self.local_dir = os.path.join("local", f"models{self.num_epochs}")
...
class MaliciousAggregation(fl.server.strategy.FedAvg):
    def __init__(self, **kwargs):
        ...
        self.model_dir = os.path.join("global", f"models{num_epochs}")
